                    ...
                    <section>
                        <header>
                            ...
                            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                                Atualize os dados cadastrais do cliente "{{ $client->name }}".
                            </p>
                        </header>
                        ...
                        <form method="post" action="{{ route('clients.update', $client->id) }}" class="mt-6 space-y-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="phone" name="phone" type="text" class="mt-1 block w-full" :value="old('phone', $client->phone)" autocomplete="tel" />
